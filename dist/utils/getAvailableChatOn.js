...
export async function getAvailableChatOn(clientNumber, advisorId) {
    try {
        ...
        if (existingConversation) {
            console.log(`🔍 Found conversation for ${clientNumber} with advisor ${advisorId || 'any'}: chat_on=${existingConversation.chat_on}, origin=${existingConversation.origin}`);
